  ...
  >
    <template v-if="type == 'password'">
      ...
      <div class="check-container remember-pwd">
        <t-checkbox v-model="formData.isRemember">记住账号</t-checkbox>
...
const onSubmit = async ({ validateResult }) => {
  if (validateResult === true) {
    try {
      ...
      const redirectUrl = redirect ? decodeURIComponent(redirect) : '/logistics';
...
onMounted(() => {
  ...
  if (userStore.accountInfo.isRemember) {
    formData.value.account = userStore.accountInfo.account
    formData.value.password = userStore.accountInfo.password
    formData.value.isRemember = userStore.accountInfo.isRemember
  }
})
</script>
